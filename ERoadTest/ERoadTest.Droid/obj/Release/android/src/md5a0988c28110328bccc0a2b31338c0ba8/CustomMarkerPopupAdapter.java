		...
		com.google.android.gms.maps.GoogleMap.InfoWindowAdapter
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TaximooTestApp.Droid.CustomMarkerPopupAdapter, TaximooTestApp.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CustomMarkerPopupAdapter.class, __md_methods);
	}


	public CustomMarkerPopupAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == CustomMarkerPopupAdapter.class)
			mono.android.TypeManager.Activate ("TaximooTestApp.Droid.CustomMarkerPopupAdapter, TaximooTestApp.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public CustomMarkerPopupAdapter (android.view.LayoutInflater p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == CustomMarkerPopupAdapter.class)
			mono.android.TypeManager.Activate ("TaximooTestApp.Droid.CustomMarkerPopupAdapter, TaximooTestApp.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Views.LayoutInflater, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
